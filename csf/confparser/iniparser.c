 ...
 */
/*--------------------------------------------------------------------------*/
static char * strlwc(char *buf, const char * s)
{
    int i ;
    ...
    while (s[i] && i<ASCIILINESZ) {
        buf[i] = (char)tolower((int)s[i]);
        i++ ;
    }
    buf[ASCIILINESZ]=(char)0;
    return buf ;
}
 ...
 */
/*--------------------------------------------------------------------------*/
static char * strstrip(char *buf, char * s)
{
	char * last ;
...
dictionary * iniparser_load_mem(const char *ini, int inilen)
{
	...
	while (((rpos = getnstr(line+last, ini+tpos, ASCIILINESZ-last))!= 0) &&
		(tpos < inilen)){
        lineno++ ;
        tpos += rpos;
        len = (int)strlen(line);
