...
ARFLAGS = rcv
IFLAGS  = -I./confparser -I./include -I/usr/local/include 
CFLAGS	= $(cflags) -fPIC
PREDEF = $(pdef) -D_POSIX_PTHREAD_SEMANTICS -DSOLARIS_API
LDFLAGS	= -L/usr/local/lib -L../lib -lconfparser -levent -lpthread \
	-lsocket -lnsl -lsendfile -lrt

LINK	= -Wl
MAIN_OBJS	= main.o
PROTOLIB_OBJS = libprotocol.o monitor.o mempool.o log.o submit_request.o common.o
MODLIB_OBJS = libmod.o monitor.o log.o pipeline_stage.o common.o
WORKER_OBJS = server.o tcp.o udp.o protocol.o data.o mempool.o pipeline_stage.o \
	pipeline.o common.o worker.o module.o monitor.o log.o
